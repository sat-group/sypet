...
public final class PetriNetFactoryFactory<T extends Type, MS extends MethodSignature<T>> implements
    edu.cmu.sypet.petrinet.frontend.PetriNetFactoryFactory<FrontendPetriNet<T, MS>, BackendPetriNet<T, MS>> {

  @Override
  public final edu.cmu.sypet.petrinet.frontend.PetriNetFactory<FrontendPetriNet<T, MS>> createFrom(
