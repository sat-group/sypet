...
//			    Arrays.asList("cmu.symonster"));
//		ArrayList<String> libs = new ArrayList<String>(
//				Arrays.asList("./lib/point.jar"));
...
//				Arrays.asList("cmu.symonster.MyPoint"));
//		
//		String tgtType = "cmu.symonster.Point";
//		
...
//		}
		...
		String testCodeMonth = "	public boolean test() throws Throwable {\n" + 
				...
				"		return localdate0.getMonth() == month;\n" + 
				"		}";
