package edu.cmu.sypet.petrinet.backends.standard;

import java.util.Map;
import java.util.Set;

public final class BackendPetriNet<Place, Transition> implements
    edu.cmu.sypet.petrinet.BackendPetriNet<Place, Transition> {
  ...
  public boolean equals(Object o) {
    ...
    BackendPetriNet<?, ?> that = (BackendPetriNet<?, ?>) o;
