...
public final class ShopDB {
  ...
  public static final Shop shop =
      new Shop(
          "jb test shop",
          new Customer(
              lucas, Canberra, new Order(reSharper), new Order(reSharper, dotMemory, dotTrace)),
          new Customer(cooper, Canberra),
          new Customer(nathan, Vancouver, new Order(rubyMine, webStorm)),
          new Customer(
              reka, Budapest, new Order(false, idea), new Order(false, idea), new Order(idea)),
          new Customer(bajram, Ankara, new Order(reSharper)),
          new Customer(asuka, Tokyo, new Order(idea)));
